...
public class WordPairInputFormat extends FileInputFormat<WordPairKey, WordPairValue> {

    public WordPairInputFormat() {
    }

    public RecordReader<WordPairKey, WordPairValue> createRecordReader(InputSplit split, TaskAttemptContext context) {
        return new RecordReader<WordPairKey, WordPairValue>() {

            protected LineRecordReader reader;
            protected WordPairKey key;
            protected WordPairValue value;
            ...
            private WordPairValue parseValue(String str){
                String[] toks = str.split("\t")[1].split(", ");
                return new WordPairValue(Integer.parseInt(toks[0]),
            ...
            @Override
            public WordPairValue getCurrentValue() throws IOException, InterruptedException {
                return value;
            }
